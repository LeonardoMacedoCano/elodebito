...
public class RestExceptionHandlerAdvice extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler({CustomException.DebitoQuantidadeParcelasInvalidasException.class})
    protected ResponseEntity<Object> handleDebitoQuantidadeParcelasInvalidasException(CustomException.DebitoQuantidadeParcelasInvalidasException ex) {
        return buildResponseEntity(HttpStatus.BAD_REQUEST, ex.getMessage());
    }

    @ExceptionHandler({CustomException.ParcelaNaoEncontradaComIdException.class})
    protected ResponseEntity<Object> handleParcelaNaoEncontradaComIdException(CustomException.ParcelaNaoEncontradaComIdException ex) {
        return buildResponseEntity(HttpStatus.NOT_FOUND, ex.getMessage());
    }
